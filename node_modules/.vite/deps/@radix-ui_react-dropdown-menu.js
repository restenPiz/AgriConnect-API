...
var DirectionProvider = __name6((props) => {
...
__name6(useDirection, "useDirection");
...
var FocusScope = React10.forwardRef(
  __name10(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
...
var Arrow = React13.forwardRef(
  __name12(function Arrow2(props, forwardedRef) {
...
var PopperAnchor = React15.forwardRef(
  __name14(function PopperAnchor2(props, forwardedRef) {
...
var PopperContent = React15.forwardRef(
  __name14(function PopperContent2(props, forwardedRef) {
    const {
      __scopePopper,
      side = "bottom",
      sideOffset = 0,
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name14((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name14(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React15.forwardRef(
  __name14(function PopperArrow2(props, forwardedRef) {
...
var transformOrigin = __name14((options2) => ({
...
var Portal = React16.forwardRef(
  __name15(function Portal2(props, forwardedRef) {
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name16((event) => {
      ...
      const handleAnimationStart = __name16((event) => {
...
__name16(getElementRef, "getElementRef");
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React18.useState(_isHydrated);
  React18.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name17(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React19.forwardRef(
  // blank line to reduce diff noise
  __name18(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React19.forwardRef(__name18(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React19.forwardRef(
  // blank line to reduce diff noise
  __name18(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name18(getDirectionAwareKey, "getDirectionAwareKey");
...
__name18(getFocusIntent, "getFocusIntent");
...
__name18(focusFirst2, "focusFirst");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name18(wrapArray, "wrapArray");
...
var Menu = __name19((props) => {
  ...
  const direction = useDirection(dir);
  React33.useEffect(() => {
    const handleKeyDown = __name19(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name19(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React33.useEffect(() => {
    ...
    const handleBlur = __name19(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React33.forwardRef(
  __name19(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React33.forwardRef(
  __name19(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React33.forwardRef(
  // blank line to reduce diff noise
  __name19(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React33.forwardRef(__name19(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime11.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React33.forwardRef(
  // blank line to reduce diff noise
  __name19(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name19((key) => {
      ...
      __name19((function updateSearch(value) {
...
var MenuGroup = React33.forwardRef(
  __name19(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React33.forwardRef(
  __name19(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React33.forwardRef(
  // blank line to reduce diff noise
  __name19(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React33.forwardRef(
  __name19(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React33.forwardRef(
  // blank line to reduce diff noise
  __name19(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name19(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React33.forwardRef(
  __name19(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React33.forwardRef(
  __name19(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React33.forwardRef(
  // blank line to reduce diff noise
  __name19(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React33.forwardRef(
  __name19(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React33.forwardRef(
  __name19(function MenuArrow2(props, forwardedRef) {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime11.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "MenuArrow")
);
var SUB_NAME = "MenuSub";
var [MenuSubProvider, useMenuSubContext] = createMenuContext(SUB_NAME);
var MenuSub = __name19((props) => {
...
var MenuSubTrigger = React33.forwardRef(
  __name19(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React33.forwardRef(
  __name19(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
__name19(getOpenState, "getOpenState");
...
__name19(getCheckedState, "getCheckedState");
...
__name19(focusFirst3, "focusFirst");
function wrapArray2(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name19(wrapArray2, "wrapArray");
...
__name19(getNextMatch, "getNextMatch");
...
__name19(isPointInPolygon, "isPointInPolygon");
function isPointerInGraceArea(event, area) {
  if (!area) return false;
  const cursorPos = { x: event.clientX, y: event.clientY };
  return isPointInPolygon(cursorPos, area);
}
__name19(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name19(whenMouse, "whenMouse");
var Root32 = Menu;
...
var DropdownMenu = __name20((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name20((props) => {
...
var DropdownMenuContent = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime12.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React34.forwardRef(__name20(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime12.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React34.forwardRef(__name20(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime12.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React34.forwardRef(__name20(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime12.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React34.forwardRef(__name20(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime12.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React34.forwardRef(__name20(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React34.forwardRef(
  // blank line to reduce diff noise
  __name20(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime12.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name20((props) => {
...
var DropdownMenuSubTrigger = React34.forwardRef(__name20(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime12.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React34.forwardRef(__name20(function DropdownMenuSubContent2(props, forwardedRef) {
